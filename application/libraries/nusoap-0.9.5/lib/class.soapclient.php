...
class nusoap_client extends nusoap_base  {
	var $username = 'GreenTelecom';				// Username for HTTP authentication
	var $password = 'GTelecom2014';				// Password for HTTP authentication
	var $authtype = 'Basic';				// Type of HTTP authentication
	var $certRequest = array();		// Certificate for HTTP SSL authentication
	var $requestHeaders = true;	// SOAP headers in request (text)
	var $responseHeaders = '';		// SOAP headers from response (incomplete namespace resolution) (text)
	var $responseHeader = NULL;		// SOAP Header from response (parsed)
	var $document = '';				// SOAP body response portion (incomplete namespace resolution) (text)
	var $endpoint  ;
	var $forceEndpoint = 'http://10.10.25.115:7782//services/CBSInterfaceAccountMgrService?wsdl';		// overrides WSDL endpoint
    var $proxyhost = '';
    var $proxyport = '';
	var $proxyusername = '';
	var $proxypassword = '';
	...
	var $timeout = 130;				// HTTP connection timeout
	var $response_timeout = 160;		// HTTP response timeout
