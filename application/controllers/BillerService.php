...
if($service == "DTH"){
$operator =  $this->operator = $json['OPERATOR'];

$txnDat = $this->_processDTH($device,$amount,$notifymsisdn,$txnReference,$operator,$ackRef,$UUID);
$result = $txnDat;
...
function _processDTH($card,$amount,$mobile,$refID,$operator,$ackRef,$UUID){

$txn = array (
            "TXN_REFERENCE" => $refID,
            "TXN_TYPE" => "DTH-".$operator,
            "REQUEST_TYPE" => $this->requestmode,
            "AGENT_ID" => $this->agent_id,
            "AGENT_MSISDN" => $this->agentMsisdn,
